...
<Dialog.Root>
	<Dialog.Trigger>
		<div class="group relative cursor-pointer {className}">
			...
			<div
				class="absolute right-1 bottom-1 flex h-6 w-6 items-center justify-center rounded-full bg-primary shadow-lg transition-all sm:hidden sm:opacity-0 sm:group-hover:opacity-100"
			>
