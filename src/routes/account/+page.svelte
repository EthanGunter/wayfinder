<script lang="ts">
	...
	import type { User, LocalUserProxy } from '$lib/API/Auth/types';
	...
	// Form states
	let editedUser = $state<Partial<User>>({});
	...
	// Initialize edited user when user loads
	$effect(() => {
	...
	function isLocalUser(user: User | null): user is LocalUserProxy {
		...
		{#if user}
			<div class="account-container">
				<header class="account-header">
					...
					{#if isLocalUser(user) && !user.isSynced}
						...
						{#if !isEditing}
							<div class="info-display">
								...
								<div class="info-item">
									...
									<p>{isLocalUser(user) && !user.isSynced ? 'Local (Not synced)' : 'Cloud (Synced)'}</p>
								</div>
							</div>
							<button class="btn-primary" onclick={() => isEditing = true}>
								Edit Profile
							</button>
						{:else}
							<form onsubmit={(e) => { e.preventDefault(); handleSave(); }}>
								<div class="form-group">
									...
									<input
										id="displayName"
										type="text"
										bind:value={editedUser.displayName}
										required
									/>
								</div>
								<div class="form-group">
				...
				{#if isLocalUser(user) && !user.isSynced}
					<div class="upgrade-section">
						...
						<button class="btn-upgrade" onclick={handleUpgradeToSync}>
				...
				<div class="danger-zone">
					...
					<button class="btn-danger" onclick={handleSignOut}>
						Sign Out
					</button>
				</div>
			</div>
